...
if __name__ == "__main__":
    """Main entry point"""
    random.seed(100)
    searching = {"Sequential Search": sequential_search, "Ordered Sequential Search": ordered_sequential_search,
    ...
    for search in searching:
        for lists in list_size:
            ...
            for i in range(100):
                ...
                results = searching[search](sorted_list, 99999999)
                total_time += results[1]
            avg_time = total_time / 100
            print(f"List Size:{lists}: {search} took {avg_time:10.7f} seconds to run on average")

"""Unsure if the way the assignments wants but I believe I got right answers"""